...
local WIDGET_DIR = gfs.get_configuration_dir() .. "widgets/batteryarc"
...
local function worker(user_args)
    ...
    local notification_position = args.notification_position or 'bottom_right' -- see naughty.notify position argument
