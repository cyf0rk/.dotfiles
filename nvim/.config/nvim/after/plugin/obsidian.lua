...
obsidian.setup({
  ...
  completion = {
    ...
    -- completion.prepend_note_id, completion.prepend_note_path, and completion.use_path_only are deprecated.
    -- check https://github.com/epwalsh/obsidian.nvim/pull/406
